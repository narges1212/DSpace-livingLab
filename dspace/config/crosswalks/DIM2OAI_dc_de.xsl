...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="dspace:field[(not(@lang) or @lang='de') and @mdschema='dc' and @element ='subject' and 
	...
	<xsl:template match="dspace:field[(not(@lang) or @lang='de') and @mdschema='dc' and @element ='publisher' and @qualifier='country']  ">
		<xsl:element name="dc:publisher">
			<xsl:value-of select="text()"/>
		</xsl:element>
	</xsl:template>
	
	<xsl:template match="dspace:field[(not(@lang) or @lang='de') and @mdschema='dc' and @element ='type' and @qualifier='document']  ">
	...
	<xsl:template match="dspace:field[(not(@lang) or @lang='de') and @mdschema='dc' and @element='description' and 
	...
	<xsl:template match="dspace:field[(not(@lang) or @lang='de') and @mdschema='dc' and @element='rights' and @qualifier='licence']">

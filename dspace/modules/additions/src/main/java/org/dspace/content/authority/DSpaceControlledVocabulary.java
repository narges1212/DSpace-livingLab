...
public class DSpaceControlledVocabulary extends SelfNamedPlugin implements ChoiceAuthority
{
    ...
    private static String xpathTemplate = "//node[contains(translate(@label,'ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÜÀÁÂÃÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕØÙÚÛÝ','abcdefghijklmnopqrstuvwxyzäöüàáâãåæçèéêëìíîïðñòóôõøùúûý'),'%s')]";

        ...
        try {
            ...
            if (dso != null && dso.getType() == Constants.ITEM) {
                ...
                if (history != null) {
                    ...
                    // Set first version as canonical to keep the PIDs correct
                    modifyHandleMetadata(history.getFirstVersion().getItem(), canonical);
...
//                + Constants.typeText[handletypeid]);
    ...
    protected String makeIdentifierBasedOnHistory(Context context, DSpaceObject dso, String handleId, VersionHistory history) throws AuthorizeException, SQLException
    {
        ...
        String canonical = getCanonical(history.getFirstVersion().getItem());

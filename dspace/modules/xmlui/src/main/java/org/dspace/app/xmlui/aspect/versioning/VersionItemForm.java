...
//    private static final Message T_summary = message("xmlui.aspect.versioning.VersionItemForm.summary");
	private static final Message T_tutorial = message("xmlui.aspect.versioning.VersionItemForm.tutorial");
	...
	public void addBody(Body body) throws WingException, SQLException, AuthorizeException {
        ...
        main.setHead(T_head1.parameterize(item.getName()));

        // Fields
        List fields = main.addList("fields", List.TYPE_FORM);
        Composite addComposite = fields.addItem().addComposite("tutorial");
        addComposite.setLabel(T_tutorial);

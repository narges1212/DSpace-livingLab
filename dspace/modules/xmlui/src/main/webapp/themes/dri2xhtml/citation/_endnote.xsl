    ...
    <xsl:template name="generateEndnote">
        ...
        <html>
            ...
            <xsl:call-template name="FieldEndnote">
             ...
             -->
            <!-- Hier sollte geprüft werde, ob die "/" oder "\" bei der Pfad richtig ist.-->
            <!-- Link to PDF "URN" -->
            ...
            <xsl:if test="$metadata/dim:field[@mdschema='dc' and @element='publisher' and @qualifier='city']/text()!='' or 
                ...
                <xsl:value-of select="$metadata/dim:field[@mdschema='dc' and @element='publisher' and @qualifier='country']/text()"/><xsl:text>&#xD;</xsl:text>                
            </xsl:if>
            <!-- Language -->
            <xsl:call-template name="FieldEndnote">
            ...
            <!-- GESIS Label -->            
                <xsl:text>%W GESIS - http://www.gesis.org</xsl:text>                
                <xsl:text>&#xD;</xsl:text>            
            <!-- SSOAR Label -->
            <xsl:text>%~ SSOAR - http://www.ssoar.info</xsl:text>                
            <xsl:text>&#xD;</xsl:text>            
            <!-- Accessdate -->
